...
public final class FragmentFriendListBinding implements ViewBinding {
  ...
  @NonNull
  public final RecyclerView friendListRV;

  private FragmentFriendListBinding(@NonNull ConstraintLayout rootView,
      @NonNull RecyclerView friendListRV) {
    this.rootView = rootView;
    this.friendListRV = friendListRV;
  }
  ...
  public static FragmentFriendListBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.friendListRV;
      RecyclerView friendListRV = ViewBindings.findChildViewById(rootView, id);
      if (friendListRV == null) {
        break missingId;
      }

      return new FragmentFriendListBinding((ConstraintLayout) rootView, friendListRV);
    }
